...
import com.example.skywatch.helpers.sendNotification
...
class Worker(appContext: Context, workerParams: WorkerParameters) :
    ...
    override suspend fun doWork(): Result {
        val repo = WeatherRepo.getInstance(
            ...
            LocalDataSource.getInstance(SkyWatchDatabase.getInstance(applicationContext).SkyWatchDao()))
...
private suspend fun createAlarm(context: Context, message: String) {
    val mediaPlayer = MediaPlayer.create(context, R.raw.sky_watch_two)
