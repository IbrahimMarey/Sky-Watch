...
import com.example.skywatch.databinding.SetAlarmDialogueBinding
...
import com.example.skywatch.models.AlertKind
...
import com.example.skywatch.views.ui.alert.viewModel.AlertViewModel
import com.example.skywatch.views.ui.alert.viewModel.AlertViewModelFactory
import com.example.skywatch.views.ui.alert.viewModel.ID
import com.example.skywatch.views.ui.alert.viewModel.Worker
import com.example.skywatch.views.ui.favorite.views.FavoriteFragmentDirections
...
class AlertFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        alertViewModelFactory = AlertViewModelFactory(WeatherRepo.getInstance(
        ...
        customAlertDialogBinding = SetAlarmDialogueBinding.inflate(LayoutInflater.from(requireContext()), null, false)
